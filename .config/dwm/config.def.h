...
static const char *micu[] = { "/home/moosicmaan/.config/.scripts/media-vol", "--mic-inc", NULL };
static const char *micd[] = { "/home/moosicmaan/.config/.scripts/media-vol", "--mic-dec", NULL };
static const char *mict[] = { "/home/moosicmaan/.config/.scripts/media-vol", "--mic-toggle", NULL };
...
static Keychord *keychords[] = {
  ...
  &((Keychord){1, {{MODKEY|AltMask,               XK_d}}, togglescratch,  {.v = ter_scratch } }),
  &((Keychord){1, {{HYPER,                        XK_8}}, togglescratch,  {.v = ter_scratch } }),
  &((Keychord){1, {{MODKEY|AltMask,               XK_j}}, togglescratch,  {.v = yazi_scratch } }),
  &((Keychord){1, {{MODKEY|AltMask,               XK_h}}, togglescratch,  {.v = yazi_scratch } }),
  ...
  &((Keychord){1, {{MODKEY|AltMask,               XK_s}}, togglescratch,  {.v = btop_scratch } }),
  ...
  &((Keychord){1, {{MODKEY|AltMask,               XK_b}}, spawn,          {.v = bluet } }),
...
/*   MEDIA KEYS   */
  ...
  &((Keychord){1, {{HYPER,                        XK_m}}, spawn,          {.v = micu } }),
  &((Keychord){1, {{HYPER,                    XK_comma}}, spawn,          {.v = micd } }),
  &((Keychord){1, {{HYPER,                   XK_period}}, spawn,          {.v = mict } }),
  &((Keychord){1, {{0,               XF86XK_AudioMedia}}, spawn,          {.v = mnow } }),
  &((Keychord){1, {{HYPER,                        XK_u}}, spawn,          {.v = mnow } }),
