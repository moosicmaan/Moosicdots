...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/moosicmaan/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/moosicmaan"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/moosicmaan/.mailcheckrc"
# }
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/moosicmaan/.now_playing.log"
