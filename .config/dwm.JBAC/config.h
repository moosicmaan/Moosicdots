...
static const Key keys[] = {
	...
	{ ControlMask|AltMask,          XK_Delete, spawn,          {.v = rofi_power } },
  ...
  { MODKEY|AltMask,               XK_g,      incrgaps,       {.i = -1 } },
  { MODKEY|AltMask|ShiftMask,     XK_h,      incrogaps,      {.i = +1 } },
  { MODKEY|AltMask|ShiftMask,     XK_g,      incrogaps,      {.i = -1 } },
  { MODKEY|AltMask|ControlMask,   XK_h,      incrigaps,      {.i = +1 } },
  { MODKEY|AltMask|ControlMask,   XK_g,      incrigaps,      {.i = -1 } },
