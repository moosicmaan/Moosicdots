...
-- APPLICATIONS
local my_term = "kitty" -- Launch default terminal
...
local my_filesc = "kitty -e yazi" -- Launch console file browser
...
local my_mux = "kitty -e tmux" -- (alt) kitty -e sh -c 'kitty @ set-spacing padding=0; tmux' Launch TMUX in kitty
