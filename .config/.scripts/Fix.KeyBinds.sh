...
KEYBINDS_CONF="$HOME/.config/hypr/conf/keybindins.conf"
USER_KEYBINDS_CONF="$HOME/.config/hypr/conf/keybinding.conf"
LAPTOP_CONF="$HOME/.config/hypr/conf/keybinding.conf"
...
echo "$KEYBINDS" | rofi -dmenu -i -p "Keybinds" -config ~/.config/rofi/config.rasi
